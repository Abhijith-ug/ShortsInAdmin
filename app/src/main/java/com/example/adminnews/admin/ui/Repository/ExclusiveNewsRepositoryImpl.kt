package com.example.adminnews.admin.ui.Repository
...
import com.example.adminnews.admin.ui.util.Constants.Companion.EXCLUSIVE_NEWS_IMAGES
import com.example.adminnews.admin.ui.util.Resource
    ...
    suspend fun updateExclusiveNewsData(exclusiveNews: ExclusiveNews, result: (UiState<Boolean>) -> Unit) {
        suspendCancellableCoroutine { continuation ->
            val updates = mapOf(
                ...
                Constants.EX_NEWS_COUNTRY to exclusiveNews.country,
