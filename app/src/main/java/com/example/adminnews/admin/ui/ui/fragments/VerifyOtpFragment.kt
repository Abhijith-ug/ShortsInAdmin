...
import com.example.adminnews.databinding.FragmentVerifyOtpBinding
            ...
            repository.getUserFromFireStore(uid) {
                when (it) {
                    is UiState.Failure -> {
                        ...
                        Session.user = User("", "", "", Constants.USER_DEFAULT_COUNTRY_VALUE, Constants.IS_USER_DEFAULT_VALUE)
                    ...
                    is UiState.Success -> {
                        ...
                        if (!Session.user.userRole) {
                            ...
                            binding.progressBar.visibility = View.GONE
                            binding.btnVerifyOtp.visibility = View.VISIBLE
                            Toast.makeText(activity, "You don't have permission to access", Toast.LENGTH_SHORT).show()
                            // Go back to the mobile number fragment.
                            findNavController().navigateUp()
                        }
                    }
