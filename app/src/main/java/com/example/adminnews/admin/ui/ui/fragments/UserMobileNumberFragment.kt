...
import com.example.adminnews.databinding.FragmentUserMobileNumberBinding
...
class UserMobileNumberFragment : Fragment(R.layout.fragment_user_mobile_number) {
    private lateinit var binding: FragmentUserMobileNumberBinding
    private lateinit var viewModel: UserViewModel
    private lateinit var firebaseAuth: FirebaseAuth
    private lateinit var callbacks: PhoneAuthProvider.OnVerificationStateChangedCallbacks
    private val TAG = "UserMobileNumberFragment"

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentUserMobileNumberBinding.inflate(layoutInflater)
        return binding.root
    }
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onCodeSent(
                ...
                Navigation.findNavController(binding.root)
                    .navigate(R.id.action_userMobileNumberFragment_to_verifyOtpFragment)
            }
        }
